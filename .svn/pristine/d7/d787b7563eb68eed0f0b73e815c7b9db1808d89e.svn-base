...
//	});
	...
	//$("div.game .editable").editable("http://localhost/Wc2010.ashx?action=saveResult&group=A&hometeam=Sydafrika&awayteam=Mexiko&homegoal=2&awaygoal=0", {
    $("div.game .editable").editable("/Wc2010.ashx?action=saveResult&group=A&hometeam=Sydafrika&awayteam=Mexiko&homegoal=2&awaygoal=0", { 
		method		: "PUT",
		id			: "gameid",
		name		: "result",
...
//         console.log(settings);
			...
			$.getJSON('/Wc2010.ashx?action=getGroup&group=' + group, function(data) {
